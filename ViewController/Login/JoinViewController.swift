...
class JoinViewController: UIViewController {
    ...
    func login() {
        ...
        UserDefaultManager.shared.user.id = self.id!
        UserDefaultManager.shared.user.pass = self.pass!
...
extension JoinViewController {
    func addAcount(email: String, pass: String, name: String, phone: String) {
        HungryAPIManager.shared.postIdPwdApiData(email: email, pass: pass, name: name, phone: phone) { code, json in
            self.Log(json)
    ...
    func getAllUsers() {
        HungryAPIManager.shared.getAllID { code, json in
