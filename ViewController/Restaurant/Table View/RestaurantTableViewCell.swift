...
class RestaurantTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        bottomView.backgroundColor = UIColor(named: "TabBarColor")
        
        titleLabel.text = ""
        titleLabel.textColor = UIColor(named: "TabBarColorReverse")
        titleLabel.backgroundColor = .clear
        titleLabel.font = .boldSystemFont(ofSize: 18)
        titleLabel.adjustsFontSizeToFitWidth = true
        
        locationLabel.text = ""
        locationLabel.textColor = UIColor(named: "TabBarColorReverse")
        locationLabel.backgroundColor = .clear
        locationLabel.font = .systemFont(ofSize: 12)
        locationLabel.adjustsFontSizeToFitWidth = true
        
        categoryLabel.text = ""
        categoryLabel.textColor = UIColor(named: "Color")
