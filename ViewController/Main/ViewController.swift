...
class ViewController: UIViewController {
    ...
    func setTabBarController() {
        ...
        self.tabBarController?.tabBar.tintColor = UIColor(named: "Color")
    ...
    func showSelectedData(x: Double, y: Double) {
        ...
        setMarker(lat: cameraPositon.target.lat, lng: cameraPositon.target.lng, type: 2, infoWindowText: selectedData?.place_name)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if selectedData?.photo?.count != 0 {
            ...
            if urlString != "" || selectedData?.photo![0] != "x" {
                ...
                cell.imageLabel.image = fixOrientation(img: UIImage(named: "MainImage")!)
            }
        } else {
            cell.imageLabel.image = fixOrientation(img: UIImage(named: "MainImage")!)
        }
