...
class DetailInfoCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        mainVIew.backgroundColor = UIColor(named: "TabBarColor")
        mainVIew.alpha = 0.8
        ...
        placeNameLabel.textColor = UIColor(named: "TabBarColorReverse")
        
        categoryNameLabel.font = .systemFont(ofSize: 15)
        categoryNameLabel.textColor = UIColor(named: "TabBarColorReverse")
        
        addressLabel.font = .systemFont(ofSize: 15)
        addressLabel.textColor = UIColor(named: "TabBarColorReverse")
